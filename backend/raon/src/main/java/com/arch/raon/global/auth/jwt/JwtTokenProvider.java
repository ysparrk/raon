package com.arch.raon.global.auth.jwt;
...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${custom.jwt.secretKey}") String secretKey, MemberRepository memberRepository) {
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        return new UsernamePasswordAuthenticationToken(member.getId(), accessToken, authorities);
